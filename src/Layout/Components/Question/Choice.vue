  ...
  <div class="choice-card">
    ...
    <div class="body">
      <b-row class="pl-3">
        ...
        <b-col md="4" v-if="status === 'multiple'">
          <b-row>
          <b-col md="6">
            <b-form-input 
              placeholder="Next" 
      ...
      <b-row class="pl-3 mt-3">
        ...
        <b-col v-if="status === 'single'" md="2" class="mt-1"><strong>Next</strong></b-col>
        <b-col v-if="status === 'single'" md="1" class="mt-1"><strong>End</strong></b-col>
