...
export const changeContactText = ({ contactTextE, contactTextF }) => {
    return httpService.post("admin/change-contact-text", {
        contactTextE,
        contactTextF
    });
};
...
export const csvUpload = formData => {
    return httpService.post("admin/csv-upload", formData);
};
